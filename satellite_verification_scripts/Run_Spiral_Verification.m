...
function varargout = Run_Spiral_Verification()
...
if ~isempty(campaign_name)
    [~, dates, directory] = merge_field_names(campaign_name);
end
...
range_file = 'ARCTAS-CA Altitude Ranges Exclusive 3'; % the file to use for the UTC ranges
